<template>
    <main class="main-page">
        ...
        <section class="main-section">
            ...
            <a class="uw-btn btn-none" href="">Узнать больше</a>
        </section>
...
import StudyMaterialList from '../components/MainPage/StudyMaterialList.vue';
import StudyMaterialDocsList from '@/components/MainPage/StudyMaterialDocsList.vue';

export default {
    name: 'MainPage',
    components: { Header, Footer, ArticleList, MainPageTitle, StudyMaterialList, StudyMaterialDocsList },
    data() {
        return {
